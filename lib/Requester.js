...
var Requester = function () {
  ...
  _createClass(Requester, [{
    ...
    value: function _delete(path) {
      ...
      return fetch(this.__urlFor(path, query), this.__options({ method: 'DELETE' })).then(_Error2.default);
    }
  }, {
    key: 'post',
    value: function post(path) {
      ...
      return fetch(this.__urlFor(path), this.__options({ body: JSON.stringify(data), method: 'POST' })).then(_Error2.default);
    }
  }, {
    key: 'put',
    value: function put(path) {
      ...
      return fetch(this.__urlFor(path), this.__options({ body: JSON.stringify(data), method: 'PUT' })).then(_Error2.default);
    }
  }, {
    key: 'request',
    value: function request(path) {
      ...
      return fetch(this.__urlFor(path, query), this.__options({ method: 'GET' })).then(_Error2.default);
    }
  }, {
    key: '__options',
